...
% Fix MyST section/chapter hierarchy for books
% Keep sections as chapters, subsections as sections
...
% Define a part command that also works like a chapter
\newcommand{\partchapter}[1]{%
  \part{#1}%
