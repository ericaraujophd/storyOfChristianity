...
As we started talking about this document, we discussed about the fact that the canon was still not closed in the early second century. The [Muratorian Fragment](https://www.ccel.org/ccel/richardson/fathers.viii.i.v.html) is the earliest known list of New Testament books, dating to around 170 AD. It provides insight into which texts were considered authoritative by early Christian communities at that time. The fragment includes most of the books that are now part of the New Testament, but it also omits some texts that were later included and includes others that were eventually excluded.
